...
local pb = require "pb"
NPL.load("(gl)script/mobile/protobuf/wire_format.lua")
NPL.load("(gl)script/mobile/protobuf/type_checkers.lua")
NPL.load("(gl)script/mobile/protobuf/encoder.lua")
NPL.load("(gl)script/mobile/protobuf/decoder.lua")
NPL.load("(gl)script/mobile/protobuf/listener.lua")
NPL.load("(gl)script/mobile/protobuf/containers.lua")
NPL.load("(gl)script/mobile/protobuf/descriptor.lua")
NPL.load("(gl)script/mobile/protobuf/text_format.lua")
